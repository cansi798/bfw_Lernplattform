...
a) Erklären Sie in eigenen Worten den Begriff "Wertschöpfungskette".
b) Wo ist die Beschaffung in der Wertschöpfungskette eines Industrieunternehmens einzuordnen?
c) Nennen Sie drei Auswirkungen einer schlechten Beschaffung auf nachgelagerte Bereiche (Produktion, Vertrieb, Kundenservice).
...
a) Geben Sie pro Ziel ein konkretes Praxisbeispiel.
b) Erläutern Sie zwei mögliche Zielkonflikte zwischen diesen R-Zielen.
c) Welches Ziel ist für Ihren Ausbildungsbetrieb am wichtigsten? Begründen Sie.
...
Die _Müller GmbH_ überlegt, die tägliche Büroreinigung künftig von einem externen Dienstleister durchführen zu lassen, statt eigene Reinigungskräfte zu beschäftigen.

| Kennzahl | Eigenleistung | Fremdbezug |
|---|---|---|
...
a) Welche Variante ist quantitativ günstiger?
b) Nennen Sie drei qualitative Faktoren, die für oder gegen den Fremdbezug sprechen.
c) Welche Empfehlung geben Sie der Geschäftsführung? Begründen Sie.
...
| Beispiel | Konzept |
|---|---|
| Mitarbeiter bestellt Büromaterial im Onlineshop von _Office-Versand AG_ | |
| Der Konzern _Bayer AG_ betreibt ein eigenes Bestellportal, in dem zugelassene Lieferanten ihre Kataloge einstellen | |
| Das Portal _Mercateo_ bündelt Sortimente vieler Lieferanten | |
...
a) Welche ökologischen Kriterien können bei einer Lieferantenauswahl berücksichtigt werden?
b) Was bedeutet das Lieferkettensorgfaltspflichtengesetz (LkSG) für die Beschaffung?
c) Wie kann die Verpackung eines Lieferanten in eine Beschaffungsentscheidung einfließen?
...
Ordnen Sie für jeden Fall das passende Beschaffungsprinzip zu (Einzelbeschaffung, Vorratsbeschaffung oder Just-in-Time) und begründen Sie kurz:

a) Eine Druckerei benötigt täglich frische Papierrollen für die laufende Produktion.
b) Ein Anwaltsbüro kauft Aktenordner für das Archiv ein.
c) Eine Werft fertigt eine Sondermaschine zur Verladung von Containern.
