...
| Material | Bedarfsart |
|---|---|
| Schreibtisch (verkaufsfertiges Endprodukt) | |
| Buchenholzplatten | |
| Schmierstoff für die Säge | |
| Schrauben und Dübel | |
| Lackierte Tischbeine (zugekauftes Halbfertigprodukt) | |
...
a) Sortieren Sie die Artikel nach Wert absteigend.
b) Berechnen Sie den prozentualen Anteil pro Artikel und den kumulierten Prozentsatz.
...
a) Verfassen Sie eine schriftliche Anfrage an die _Bürofix AG, Hauptstraße 5, 80331 München_.
...
| Angebot | Listenpreis pro Stück | Liefererrabatt | Lieferer­skonto | Bezugskosten gesamt |
|---|---|---|---|---|
| Lieferant A | 4,50 € | 10 % | 2 % | 25 € |
| Lieferant B | 4,80 € | 12 % |  3 % | 18 € |
| Lieferant C | 4,20 € |  5 % |  2 % | 30 € |

a) Berechnen Sie für jedes Angebot den **Bezugspreis pro Stück** über das Schema: Listeneinkaufspreis → Liefererrabatt → Zieleinkaufspreis → Lieferer­skonto → Bareinkaufspreis → +Bezugskosten → Bezugspreis.
...
a) Berechnen Sie pro Lieferant den gewichteten Nutzwert.
b) Welcher Lieferant ist nach der Nutzwertanalyse am besten?
c) Vergleichen Sie das Ergebnis mit Aufgabe 4. Wie würden Sie endgültig entscheiden?
