...
\begin{enumerate}
  ...
  \item \textbf{Wertschätzung (Ich-Bedürfnisse)} --- Anerkennung, Status, Erfolg.
  \item \textbf{Selbstverwirklichung} --- Entfaltung der eigenen Fähigkeiten.
\end{enumerate}

Die unteren vier Stufen (Physiologie, Sicherheit, Soziales, Wertschätzung) gelten als
\emph{Defizitbedürfnisse} (ihr Fehlen wird als Mangel empfunden und ist grundsätzlich
sättigbar), die oberste Stufe (Selbstverwirklichung) als \emph{Wachstumsbedürfnis}
(nie vollständig zu befriedigen). Das Modell ist anschaulich, aber vereinfachend ---
in der Realität verlaufen die Übergänge fließend.
