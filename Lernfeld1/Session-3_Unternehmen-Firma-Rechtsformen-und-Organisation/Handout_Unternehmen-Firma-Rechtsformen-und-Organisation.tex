...
\begin{enumerate}
  \item \textbf{Firmenwahrheit} (§ 18 Abs.\ 2 HGB) --- Die Firma darf keine Angaben
    enthalten, die geeignet sind, über geschäftliche Verhältnisse \emph{irrezuführen}. Sie
    muss also der Wahrheit entsprechen (z.\,B.\ zum tatsächlichen Gegenstand des
    Unternehmens).
  \item \textbf{Firmenklarheit} (§ 18 Abs.\ 1 HGB) --- Die Firma muss zur \emph{Kennzeichnung}
    des Kaufmanns geeignet sein und \emph{Unterscheidungskraft} besitzen; sie muss klar und
    verständlich sein.
...
\begin{merksatz}
\textbf{Zuordnung § 18 HGB:} Absatz~1 verlangt Kennzeichnungs\-eignung und Unterscheidungs\-kraft
(\emph{Firmenklarheit}); Absatz~2 verbietet irreführende Angaben (\emph{Firmenwahrheit}).
Kurz: Die Firma muss \emph{unterscheidbar} (Klarheit) und \emph{ehrlich} (Wahrheit) sein.
\end{merksatz}
...
\begin{center}
\begin{tabular}{p{2.9cm} p{3.2cm} p{3.2cm} p{3.4cm}}
\toprule
...
\glossareintrag{Firmenwahrheit}{Grundsatz (§ 18 Abs.\ 2 HGB), dass die Firma keine über geschäftliche Verhältnisse irreführenden Angaben enthalten darf.}

\glossareintrag{Firmenklarheit}{Grundsatz (§ 18 Abs.\ 1 HGB), dass die Firma zur Kennzeichnung geeignet sein muss und Unterscheidungskraft besitzt.}
